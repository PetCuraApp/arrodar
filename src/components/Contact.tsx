      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Estamos aquí para responder todas tus preguntas. Completa el formulario
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">Av. Principal 1234, Valdivia, Chile</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">contacto@arrodar.cl</p>
                  </div>
                </div>
        ...
        <motion.div
          ...
          className="mt-12 rounded-xl overflow-hidden shadow-lg h-96 bg-gray-200"
        >
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13343.236036727305!2d-73.23506305624112!3d-39.81979672308967!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9615ee891aab33e5%3A0x35c9b4ab79b2d79b!2sValdivia%2C%20Los%20R%C3%ADos!5e1!3m2!1ses-419!2scl!4v1755909926279!5m2!1ses-419!2scl" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            allowFullScreen 
            ...
            title="Ubicación de Arrodar en Valdivia"
          />
        </motion.div>
      </div>
    </section>
